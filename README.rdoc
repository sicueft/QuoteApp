...
v0.0.0 3/31/15
  - Initialized the Rails application from scratch. Created a repository on Github and created a README file.
...
are Ruby on Rails for the backend, Bootstrap, Javascript, and Jquery for the client side. We will use third 
